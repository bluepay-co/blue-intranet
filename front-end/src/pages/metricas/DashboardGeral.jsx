            ...
            {ehMesAtual && (
              <div>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <KpiCard icon={RefreshCw}  cor="bg-violet-500/10 text-violet-600" valor={moeda(hoje.mediaDiariaReceita)}            rotulo={`Média diária · ${Math.round(hoje.mediaDiariaTickets)} tickets/dia`} />
                </div>
              </div>
            )}
